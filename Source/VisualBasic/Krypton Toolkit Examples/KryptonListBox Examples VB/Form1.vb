...
'
' VB.NET twin of Source\Krypton Toolkit Examples\KryptonListBox Examples\Form1.cs (Bastion Phase 4c).
#End Region
...
Public Class Form1
    ...
    Private Function CreateNewItem() As Object
        Dim item As New KryptonListItem With {
            .ShortText = $"Item {_next}",
            .LongText = $"({_rand.Next(Integer.MaxValue)})",
    ...
    Private Sub kryptonListBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles kryptonListBox.SelectedIndexChanged
    ...
    Private Sub buttonAppend_Click(sender As Object, e As EventArgs) Handles buttonAppend.Click
        ...
        If kryptonListBox.SelectedIndex = -1 Then
            kryptonListBox.SelectedIndex = 0
        End If
    End Sub
    ...
    Private Sub buttonInsert_Click(sender As Object, e As EventArgs) Handles buttonInsert.Click
        ...
        If kryptonListBox.SelectedIndex >= 0 Then
    ...
    Private Sub buttonRemove_Click(sender As Object, e As EventArgs) Handles buttonRemove.Click
        ...
        If kryptonListBox.SelectedIndex >= 0 Then
            ...
            Dim index As Integer = kryptonListBox.SelectedIndex
            If index = (kryptonListBox.Items.Count - 1) Then
                index -= 1
            End If
            ...
            ' Select the new item
            If index < kryptonListBox.Items.Count Then
    ...
    Private Sub kryptonListBox_DoubleClick(sender As Object, e As EventArgs) Handles kryptonListBox.DoubleClick
