...
'
' VB.NET twin of Source\Krypton Toolkit Examples\KryptonLabel Examples\Form1.cs (Bastion Phase 4c).
#End Region
...
Public Class Form1
    ...
    Private Sub kryptonLabel_MouseDown(sender As Object, e As MouseEventArgs) Handles kryptonLabel1.MouseDown,
        ...
        ' Setup the property grid to edit this label
        propertyGrid.SelectedObject = New KryptonLabelProxy(CType(sender, KryptonLabel))
    End Sub
...
Public Class KryptonLabelProxy
    ...
    Private _label As KryptonLabel

    Public Sub New(label As KryptonLabel)
        _label = label
    End Sub
