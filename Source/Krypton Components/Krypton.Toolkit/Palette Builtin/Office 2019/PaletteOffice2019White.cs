...
/// <summary>
/// Provides the Office 2019 White appearance (Bastion).
/// </summary>
public class PaletteOffice2019White : PaletteMicrosoft365Base
{
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2019White class.
    /// </summary>
    public PaletteOffice2019White() : base(
        new PaletteOffice2019White_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
