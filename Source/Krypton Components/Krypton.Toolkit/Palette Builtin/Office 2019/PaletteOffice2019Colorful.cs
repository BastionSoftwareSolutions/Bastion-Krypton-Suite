...
// =====================================================================================
// Office 2019 Colorful theme (Bastion Phase 3 fidelity pass, spec §4.3).
// Colours come from PaletteOffice2019Colorful_BaseScheme (provenance documented there:
// docs\themes\office2019-colours.md + reference images under
// docs\themes\references\office2019\). This class supplies the accent chrome the
// scheme slots cannot reach: the Word-blue #2B579A tab row
...
/// <summary>
/// Provides the Office 2019 Colorful appearance (Bastion).
/// </summary>
public class PaletteOffice2019Colorful : PaletteMicrosoft365Base
{
    #region Static Fields

    #region Ribbon Specific Colors

    // [T] office2019-colours.md: tab row continues the accent title bar — Word blue #2B579A ([H] exact).
    ...
    // [T] File button fill = app accent #2B579A.
    ...
    static PaletteOffice2019Colorful()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2019Colorful class.
    /// </summary>
    public PaletteOffice2019Colorful() : base(
        new PaletteOffice2019Colorful_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
