...
// =====================================================================================
// Microsoft 365 "Silver" colour scheme — 2026 refresh (Bastion Phase 3, spec §4.2
// item 4).
//
// VARIANT MAPPING (Bastion decision): Silver has NO real-2026 M365 counterpart (the
// real options are White/Colorful/Dark Gray/Black). It is kept as a Krypton
// convenience, refreshed as a DERIVED variant of the real "White" mapping:
// White's scheme with the frame neutral stepped one rung down the authentic 2026
// neutral ladder — #E9EEF2 (frame) → #DCE0E4 (the [M1] ruler-margin neutral), with
// hover = #D1D1D1 separator tone and pressed = frame −23 step #C5C9CD. No fake
// "official" values were invented: every colour is either a 2026 table value ([T]) or
// derived by the stated rule ([D]). Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365Silver.png.
//
// Provenance tags: [T] = value identical to a docs\themes\m365-2026-colours.md table
// value; [D] = derived (rule inline or the frame-step rule above); [N] = donor value
...
public sealed class PaletteMicrosoft365Silver_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(220, 224, 228); // [D] document surround #E9EDF2/#DCE0E4 family
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(220, 224, 228); // [D] frame neutral #DCE0E4
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(220, 224, 228); // [D] frame neutral #DCE0E4
    ...
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(220, 224, 228); // [D] flat neutral frame #DCE0E4 — no accent in White
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive frame — colour-table open item 4
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4 (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4 (flat frame)
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4 — caption merges into chrome
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive — open item 4
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(220, 224, 228); // [D] title bar #DCE0E4
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(220, 224, 228); // [D] title bar #DCE0E4
    ...
    public override Color RibbonTabSeparatorColor          { get; set; } = Color.FromArgb(220, 224, 228); // [D] tab row #DCE0E4 — 2026 draws no tab separators
    ...
    public override Color RibbonGroupDialogLight           { get; set; } = Color.FromArgb(220, 224, 228); // [D] frame neutral #DCE0E4
    ...
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(220, 224, 228); // [D] QAT minibar sits on the neutral title bar #DCE0E4
    public override Color RibbonQATMini2                   { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    public override Color RibbonQATMini3                   { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    ...
    public override Color GridSheetColNormal1              { get; set; } = Color.FromArgb(220, 224, 228); // [D] grid headers take the frame neutral #DCE0E4
    public override Color GridSheetColNormal2              { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    ...
    public override Color GridSheetRowNormal               { get; set; } = Color.FromArgb(220, 224, 228); // [D] frame neutral #DCE0E4
