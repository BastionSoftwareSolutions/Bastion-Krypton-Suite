...
// =====================================================================================
// Microsoft 365 "Silver Dark Mode" colour scheme — 2026 refresh (Bastion Phase 3,
// spec §4.2 item 4).
//
// VARIANT MAPPING (Bastion decision): no real-2026 counterpart; kept as a Krypton
// convenience DERIVED from the real "Dark Gray" mapping (its parent Silver's dark
// companion IS the mid-dark gray ladder). Rule: the Dark Gray scheme with the frame
// taken as the [M5] uniform band tone #52585D (the cooler cast) instead of #54585A —
// a near-twin of Microsoft365DarkGray, distinguished only by that cast.
// Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365SilverDarkMode.png.
//
// Provenance tags: [T] = docs\themes\m365-2026-colours.md table value ([M5]);
// [D] = derived (rule inline or the band-cast rule above); [N] = 2021-pass donor.
// =====================================================================================
...
public sealed class PaletteMicrosoft365SilverDarkMode_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color TextButtonChecked                { get; set; } = Color.White;                   // [D] checked fills come from this clone base's mid-tone ButtonBackColor registrations (#667: 102,117,161) — white text for readability
    ...
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(82, 88, 93);    // [D] app frame / document surround #52585D
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D
    ...
    public override Color SeparatorDark                    { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D
    ...
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D (status open item 1)
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D
    ...
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(82, 88, 93);    // [D] frame #52585D (flat frame)
    ...
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(82, 88, 93);    // [D] title bar #52585D ([M5] rect 300,55)
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(82, 88, 93);    // [D] title bar #52585D
    ...
    public override Color RibbonTabSeparatorColor          { get; set; } = Color.FromArgb(82, 88, 93);    // [D] tab row #52585D — 2026 draws no tab separators
    ...
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(82, 88, 93);    // [D] QAT minibar sits on the #52585D title bar
    public override Color RibbonQATMini2                   { get; set; } = Color.FromArgb(82, 88, 93);    // [D] #52585D
    public override Color RibbonQATMini3                   { get; set; } = Color.FromArgb(82, 88, 93);    // [D] #52585D
