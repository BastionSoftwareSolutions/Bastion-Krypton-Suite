...
// =====================================================================================
// Microsoft 365 "Black Dark Mode Alternate" colour scheme — 2026 refresh (Bastion
// Phase 3, spec §4.2 item 4).
//
// VARIANT MAPPING (Bastion decision): no separate real-2026 counterpart; kept as a
// Krypton convenience DERIVED from the real "Black" mapping (via BlackDarkMode).
// Rule: the FLAT alternate — the #1C2227 frame is promoted to the #292929 card tone
// (frame = card, one flat surface, matching the lighter-frame intent of the upstream
// Alternate), and input wells recess to the [M6] #0A0A0A header-band tone for
// contrast. Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365BlackDarkModeAlternate.png.
//
// Provenance tags: [T] = docs\themes\m365-2026-colours.md table value ([M6]);
// [D] = derived (rule inline or the flat-frame rule above); [N] = 2021-pass donor.
// =====================================================================================
...
public sealed class PaletteMicrosoft365BlackDarkModeAlternate_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color TextButtonChecked                { get; set; } = Color.White;                   // [T] primary chrome text #FFFFFF
    ...
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(41, 41, 41);    // [D] app frame #292929
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(41, 41, 41);    // [D] frame #292929
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(41, 41, 41);    // [D] frame #292929
    ...
    public override Color GripDark                         { get; set; } = Color.FromArgb(41, 41, 41);    // [D] frame #292929
    public override Color ToolStripBack                    { get; set; } = Color.FromArgb(41, 41, 41);    // [D] toolbar strip merges into the card #292929
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(41, 41, 41);    // [D] frame #292929 (status open item 1)
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(41, 41, 41);    // [D] frame #292929
    public override Color ImageMargin                      { get; set; } = Color.FromArgb(54, 54, 54);    // [D] matches the dark menu image column
    ...
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(41, 41, 41);    // [D] frame #292929 — active frame
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(119, 119, 119); // [N] inactive frame — colour-table open item 4
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929 (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929 (flat frame)
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929 — caption merges into chrome
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(154, 154, 154); // [N] inactive — open item 4
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(41, 41, 41);    // [D] title bar #292929 ([M6] rect 300,55)
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(41, 41, 41);    // [D] title bar #292929
    ...
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(41, 41, 41);    // [D] QAT minibar sits on the #292929 title bar
    public override Color RibbonQATMini2                   { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929
    public override Color RibbonQATMini3                   { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929
    ...
    public override Color NavigatorMiniBackColor           { get; set; } = Color.FromArgb(41, 41, 41);    // [D] card #292929
    public override Color GridListNormal1                  { get; set; } = Color.FromArgb(41, 41, 41);    // [D] dark list canvas = card #292929 (clone base renders light text)
    public override Color GridListNormal2                  { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929
    public override Color GridListPressed1                 { get; set; } = Color.FromArgb(53, 53, 53);    // [D] well #353535
    public override Color GridListPressed2                 { get; set; } = Color.FromArgb(41, 41, 41);    // [D] #292929
    public override Color GridListSelected                 { get; set; } = Color.FromArgb(100, 155, 207); // [T] row-header selected tint #649BCF ([M6] point 48,520)
    public override Color GridSheetColNormal1              { get; set; } = Color.FromArgb(10, 10, 10);    // [T] column/row header band #0A0A0A ([M6] rect 270,478)
    public override Color GridSheetColNormal2              { get; set; } = Color.FromArgb(10, 10, 10);    // [T] #0A0A0A
    public override Color GridSheetColPressed1             { get; set; } = Color.FromArgb(53, 53, 53);    // [D] header pressed = well #353535 (hover open item 2)
    public override Color GridSheetColPressed2             { get; set; } = Color.FromArgb(53, 53, 53);    // [D] #353535
    ...
    public override Color GridSheetRowNormal               { get; set; } = Color.FromArgb(10, 10, 10);    // [T] header band #0A0A0A
    public override Color GridSheetRowPressed              { get; set; } = Color.FromArgb(53, 53, 53);    // [D] #353535
    ...
    public override Color GridDataCellBorder               { get; set; } = Color.FromArgb(61, 61, 61);    // [D] separator #3D3D3D on the dark canvas
    public override Color GridDataCellSelected             { get; set; } = Color.FromArgb(91, 157, 218);  // [T] header accent #5B9DDA ([M6] rect 270,478)
    ...
    public override Color InputControlBackNormal           { get; set; } = Color.FromArgb(10, 10, 10);    // [D] Alternate recess wells use the [M6] band #0A0A0A
    public override Color InputControlBackDisabled         { get; set; } = Color.FromArgb(31, 31, 31);    // [D] card −10
    public override Color InputControlBackInactive         { get; set; } = Color.FromArgb(16, 16, 16);    // [D] band +6
    ...
    public override Color ContextMenuHeadingBack           { get; set; } = Color.FromArgb(41, 41, 41);    // [D] dark menus = card #292929 (variant colour table)
    public override Color ContextMenuHeadingText           { get; set; } = Color.FromArgb(222, 223, 224); // [D] control text #DEDFE0
    public override Color ContextMenuImageColumn           { get; set; } = Color.FromArgb(54, 54, 54);    // [D] menu image column one step above the card
