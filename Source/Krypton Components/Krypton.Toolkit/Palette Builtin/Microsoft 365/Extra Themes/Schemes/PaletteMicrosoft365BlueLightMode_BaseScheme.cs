...
// =====================================================================================
// Microsoft 365 "Blue Light Mode" colour scheme — 2026 refresh (Bastion Phase 3,
// spec §4.2 item 4).
//
// VARIANT MAPPING (Bastion decision): no real-2026 counterpart; kept as a Krypton
// convenience DERIVED from its parent Microsoft365Blue (= real "Colorful"): the
// low-chrome light companion drops the #185ABD accent title fill (the body of
// Colorful and White is identical in 2026) and keeps the Blue identity by tinting
// the caption text with the accent companion #1651AA. Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365BlueLightMode.png.
//
// Provenance tags: [T] = value identical to a docs\themes\m365-2026-colours.md table
// value; [D] = derived (rule inline or the accent-drop rule above); [N] = donor value
...
public sealed class PaletteMicrosoft365BlueLightMode_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(233, 238, 242); // [T] document surround #E9EDF2/#E9EEF2 family ([M4] point 500,450)
    ...
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(233, 238, 242); // [T] flat neutral frame #E9EEF2 — no accent in White
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive frame — colour-table open item 4
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(233, 238, 242); // [T] #E9EEF2 (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(233, 238, 242); // [T] #E9EEF2 (flat frame)
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.FromArgb(233, 238, 242); // [T] #E9EEF2 — caption merges into chrome
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive — open item 4
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(233, 238, 242); // [T] title bar #E9EEF2 ([M4] rect 400,60)
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(233, 238, 242); // [T] title bar #E9EEF2
    ...
    public override Color FormHeaderShortActive            { get; set; } = Color.FromArgb(22, 81, 170);    // [D] caption text tinted with the accent companion #1651AA (Blue identity on the neutral frame)
    public override Color FormHeaderShortInactive          { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 4
    public override Color FormHeaderLongActive             { get; set; } = Color.FromArgb(22, 81, 170);    // [D] caption text tinted with the accent companion #1651AA (Blue identity on the neutral frame)
    public override Color FormHeaderLongInactive           { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 4
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(221, 226, 230); // [D] caption hover = shadow step #DDE2E6 (hover open item 2)
    public override Color FormButtonBack1Track             { get; set; } = Color.FromArgb(221, 226, 230); // [D] #DDE2E6
    public override Color FormButtonBack2Track             { get; set; } = Color.FromArgb(221, 226, 230); // [D] #DDE2E6
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(220, 224, 228); // [D] pressed = ruler neutral #DCE0E4
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    public override Color TextButtonFormNormal             { get; set; } = Color.FromArgb(22, 81, 170);    // [D] caption text tinted with the accent companion #1651AA (Blue identity on the neutral frame)
    public override Color TextButtonFormTracking           { get; set; } = Color.FromArgb(22, 81, 170);    // [D] caption text tinted with the accent companion #1651AA (Blue identity on the neutral frame)
    public override Color TextButtonFormPressed            { get; set; } = Color.FromArgb(22, 81, 170);    // [D] caption text tinted with the accent companion #1651AA (Blue identity on the neutral frame)
    ...
    public override Color FormButtonBack1Checked           { get; set; } = Color.FromArgb(220, 224, 228); // [D] checked caption button = ruler neutral #DCE0E4
    public override Color FormButtonBack2Checked           { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    public override Color FormButtonBorderCheck            { get; set; } = Color.FromArgb(220, 224, 228); // [D] #DCE0E4
    ...
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(233, 238, 242); // [D] QAT minibar sits on the neutral title bar #E9EEF2
    public override Color RibbonQATMini2                   { get; set; } = Color.FromArgb(233, 238, 242); // [D] #E9EEF2
    public override Color RibbonQATMini3                   { get; set; } = Color.FromArgb(233, 238, 242); // [D] #E9EEF2
    ...
    public override Color GridSheetColNormal1              { get; set; } = Color.FromArgb(233, 238, 242); // [D] grid headers take the frame neutral #E9EEF2
    public override Color GridSheetColNormal2              { get; set; } = Color.FromArgb(233, 238, 242); // [D] #E9EEF2
    public override Color GridSheetColPressed1             { get; set; } = Color.FromArgb(220, 224, 228); // [D] header pressed = ruler neutral #DCE0E4 (hover open item 2)
