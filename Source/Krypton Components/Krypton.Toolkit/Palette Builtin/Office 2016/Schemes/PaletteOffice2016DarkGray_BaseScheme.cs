...
// =====================================================================================
// Office 2016 Dark Gray colour scheme (Bastion Phase 3 fidelity pass, spec §4.3).
//
// Provenance — every value is tagged:
//   [T] taken from docs\themes\office2016-colours.md ("Dark Gray variant" table;
//       sources [E] powerpoint-darkgray.png and [F] darkgray-theme-2016.png,
//       reference images under docs\themes\references\office2019\ and office2016\).
...
/// <summary>
/// Provides the colour scheme values that back the Office 2016 Dark Gray theme (Bastion Phase 3 fidelity pass).
/// </summary>
public sealed class PaletteOffice2016DarkGray_BaseScheme : KryptonColorSchemeBase
{
