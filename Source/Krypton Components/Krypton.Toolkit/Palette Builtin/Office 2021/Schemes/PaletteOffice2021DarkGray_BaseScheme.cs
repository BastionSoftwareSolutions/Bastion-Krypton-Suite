...
// =====================================================================================
// Office 2021/2024 Dark Gray colour scheme (Bastion Phase 3 fidelity pass, spec §4.3).
//
// Provenance — every value is tagged:
//   [T] taken from docs\themes\office2021-colours.md ("Dark Gray variant" table;
//       source [K] powerpoint-darkgray.jpg, reference images under
//       docs\themes\references\office2021\).
//       Key values: title bar / tab row #2E2E2E (46,46,46) — [K] rects 250,8 /
//       300,70 uniform; tab text #FFFFFF; toolbar strip (QAT/secondary bar)
//       #424242 (66,66,66) — [K] rect 260,102 uniform; disabled command text
//       #7A7A7A band.
//   [D] derived — rule stated inline. THE RIBBON IS COLLAPSED IN THE OFFICIAL CROP
//       (colour-table open item 1): the expanded-ribbon interior is derived from
//       the 2019 Black donor scheme by the rule "surface tones +12/channel" — the
//       offset between the 2021 Dark Gray toolbar strip #424242 [T] and the 2019
//       Black ribbon #363636, which the table expects to be the ribbon-card family
//       here. Ribbon card #424242, control well #4A4A4A, separators #656565, side
//       pane #313131, hover row #3A3A3A (chrome +12). Text tones carried unchanged
//       from the donor (#DADADA control text, #B4B4B4 secondary). ALL such slots
//       are flagged for replacement from Chris's live ribbon-pinned screenshots.
...
/// <summary>
/// Provides the colour scheme values that back the Office 2021 Dark Gray theme (Bastion Phase 3 fidelity pass).
/// </summary>
public sealed class PaletteOffice2021DarkGray_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color ButtonNormalBorder               { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators — donor #595959 +12/channel = #656565
    public override Color ButtonNormalDefaultBorder        { get; set; } = Color.FromArgb(101, 101, 101); // [D] #656565
    public override Color ButtonNormalBack1                { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well — donor #3E3E3E +12 = #4A4A4A
    public override Color ButtonNormalBack2                { get; set; } = Color.FromArgb(74, 74, 74);    // [D] #4A4A4A
    public override Color ButtonNormalDefaultBack1         { get; set; } = Color.FromArgb(86, 86, 86);    // [D] well +12 emphasis step (donor rule)
    public override Color ButtonNormalDefaultBack2         { get; set; } = Color.FromArgb(86, 86, 86);    // [D] #565656
    public override Color ButtonNormalNavigatorBack1       { get; set; } = Color.FromArgb(44, 44, 44);    // [N]
    public override Color ButtonNormalNavigatorBack2       { get; set; } = Color.FromArgb(44, 44, 44);    // [N]
    public override Color PanelClient                      { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon card #424242 = toolbar strip [T] (expanded ribbon not in crop — open item 1)
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(49, 49, 49);    // [D] side pane — donor #252525 +12 = #313131
    public override Color ControlBorder                    { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565 (donor +12)
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    public override Color HeaderSecondaryBack1             { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon #424242
    public override Color HeaderSecondaryBack2             { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon #424242
    ...
    public override Color SeparatorLight                   { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color SeparatorDark                    { get; set; } = Color.Black;                   // [N]
    public override Color GripLight                        { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color GripDark                         { get; set; } = Color.FromArgb(27, 27, 27);    // [N]
    public override Color ToolStripBack                    { get; set; } = Color.FromArgb(66, 66, 66);    // [T] toolbar strip #424242 ([K] rect 260,102)
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(46, 46, 46);    // [D] chrome #2E2E2E (status bar not in crop)
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(46, 46, 46);    // [D] chrome #2E2E2E
    public override Color ImageMargin                      { get; set; } = Color.White;                   // [N]
    public override Color ToolStripBegin                   { get; set; } = Color.FromArgb(66, 66, 66);    // [T] toolbar strip #424242
    public override Color ToolStripMiddle                  { get; set; } = Color.FromArgb(66, 66, 66);    // [T] toolbar strip #424242
    public override Color ToolStripEnd                     { get; set; } = Color.FromArgb(66, 66, 66);    // [T] toolbar strip #424242
    public override Color OverflowBegin                    { get; set; } = Color.FromArgb(49, 49, 49);    // [D] side-pane tone #313131 for overflow chrome
    public override Color OverflowMiddle                   { get; set; } = Color.FromArgb(49, 49, 49);    // [D] #313131
    public override Color OverflowEnd                      { get; set; } = Color.FromArgb(49, 49, 49);    // [D] #313131
    public override Color ToolStripBorder                  { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(46, 46, 46);    // [T] title bar #2E2E2E — active frame
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(119, 119, 119); // [N] inactive — open item 3
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(46, 46, 46);    // [T] #2E2E2E (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(46, 46, 46);    // [T] #2E2E2E (flat frame)
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.FromArgb(46, 46, 46);    // [T] #2E2E2E — caption merges into tab row
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(154, 154, 154); // [N] inactive — open item 3
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(46, 46, 46);    // [T] title bar #2E2E2E ([K] rect 250,8 — 100% uniform)
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(46, 46, 46);    // [T] title bar #2E2E2E
    ...
    public override Color FormHeaderShortActive            { get; set; } = Color.White;                   // [T] chrome text white ([K] AutoSave row)
    ...
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(58, 58, 58);    // [D] caption hover = chrome +12/channel #3A3A3A (open item 1)
    public override Color FormButtonBack1Track             { get; set; } = Color.FromArgb(58, 58, 58);    // [D] #3A3A3A
    public override Color FormButtonBack2Track             { get; set; } = Color.FromArgb(58, 58, 58);    // [D] #3A3A3A
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(74, 74, 74);    // [D] pressed = control-well step #4A4A4A
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(74, 74, 74);    // [D] #4A4A4A
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(74, 74, 74);    // [D] #4A4A4A
    ...
    public override Color RibbonTabSelected1               { get; set; } = Color.FromArgb(66, 66, 66);    // [D] selected tab merges into the #424242 ribbon card (open item 1)
    public override Color RibbonTabSelected2               { get; set; } = Color.FromArgb(66, 66, 66);    // [D] #424242
    public override Color RibbonTabSelected3               { get; set; } = Color.FromArgb(66, 66, 66);    // [D] #424242
    public override Color RibbonTabSelected4               { get; set; } = Color.FromArgb(66, 66, 66);    // [D] #424242
    public override Color RibbonTabSelected5               { get; set; } = Color.FromArgb(66, 66, 66);    // [D] #424242
    public override Color RibbonTabTracking1               { get; set; } = Color.FromArgb(58, 58, 58);    // [D] tab hover = chrome +12/channel #3A3A3A (open item 1)
    public override Color RibbonTabTracking2               { get; set; } = Color.FromArgb(58, 58, 58);    // [D] #3A3A3A
    public override Color RibbonTabHighlight1              { get; set; } = Color.FromArgb(66, 66, 66);    // [D] mirrors RibbonTabSelected1
    public override Color RibbonTabHighlight2              { get; set; } = Color.FromArgb(66, 66, 66);    // [D] mirrors selected fill
    public override Color RibbonTabHighlight3              { get; set; } = Color.FromArgb(66, 66, 66);    // [D] mirrors selected fill
    public override Color RibbonTabHighlight4              { get; set; } = Color.FromArgb(66, 66, 66);    // [D] mirrors selected fill
    public override Color RibbonTabHighlight5              { get; set; } = Color.FromArgb(66, 66, 66);    // [D] mirrors selected fill
    public override Color RibbonTabSeparatorColor          { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color RibbonGroupsArea1                { get; set; } = Color.FromArgb(66, 66, 66);    // [D] flat with ribbon (donor keeps Area1 ≈ body)
    public override Color RibbonGroupsArea2                { get; set; } = Color.FromArgb(83, 83, 83);    // [D] body +17/channel (donor offset)
    public override Color RibbonGroupsArea3                { get; set; } = Color.FromArgb(87, 87, 87);    // [D] body +21/channel (donor offset)
    public override Color RibbonGroupsArea4                { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon card #424242 = toolbar strip [T] (open item 1)
    public override Color RibbonGroupsArea5                { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon card #424242
    ...
    public override Color RibbonMinimizeBarDark            { get; set; } = Color.FromArgb(46, 46, 46);    // [D] chrome #2E2E2E
    public override Color RibbonMinimizeBarLight           { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon #424242
    ...
    public override Color RibbonGroupFrameBorder1          { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color RibbonGroupFrameBorder2          { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color RibbonGroupFrameInside1          { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    public override Color RibbonGroupFrameInside2          { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    ...
    public override Color FormButtonBack1Checked           { get; set; } = Color.FromArgb(58, 58, 58);    // [D] chrome +12 step #3A3A3A
    public override Color FormButtonBack2Checked           { get; set; } = Color.FromArgb(58, 58, 58);    // [D] #3A3A3A
    public override Color FormButtonBorderCheck            { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control-well step #4A4A4A
    public override Color FormButtonBack1CheckTrack        { get; set; } = Color.FromArgb(74, 74, 74);    // [D] #4A4A4A
    public override Color FormButtonBack2CheckTrack        { get; set; } = Color.FromArgb(74, 74, 74);    // [D] #4A4A4A
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(46, 46, 46);    // [D] QAT minibar sits on the #2E2E2E title bar
    public override Color RibbonQATMini2                   { get; set; } = Color.FromArgb(46, 46, 46);    // [D] chrome #2E2E2E
    public override Color RibbonQATMini3                   { get; set; } = Color.FromArgb(46, 46, 46);    // [D] chrome #2E2E2E
    ...
    public override Color RibbonQATFullbar1                { get; set; } = Color.FromArgb(66, 66, 66);    // [T] toolbar strip #424242
    public override Color RibbonQATFullbar2                { get; set; } = Color.FromArgb(66, 66, 66);    // [T] toolbar strip #424242
    public override Color RibbonQATFullbar3                { get; set; } = Color.FromArgb(49, 49, 49);    // [D] side-pane tone #313131
    public override Color RibbonQATButtonDark              { get; set; } = Color.FromArgb(62, 62, 62);    // [N]
    public override Color RibbonQATButtonLight             { get; set; } = Color.FromArgb(152, 152, 152); // [N]
    public override Color RibbonQATOverflow1               { get; set; } = Color.FromArgb(173, 173, 173); // [N]
    public override Color RibbonQATOverflow2               { get; set; } = Color.FromArgb(80, 80, 80);    // [N]
    public override Color RibbonGroupSeparatorDark         { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    ...
    public override Color InputControlTextDisabled         { get; set; } = Color.FromArgb(122, 122, 122); // [T] disabled command text #7A7A7A band ([K] toolbar row)
    public override Color InputControlBorderNormal         { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color InputControlBorderDisabled       { get; set; } = Color.FromArgb(82, 82, 82);    // [D] border dimmed one step (donor #464646 +12)
    public override Color InputControlBackNormal           { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    public override Color InputControlBackDisabled         { get; set; } = Color.FromArgb(60, 60, 60);    // [D] well dimmed toward ribbon tone (donor +12)
    public override Color InputControlBackInactive         { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon #424242
    ...
    public override Color InputDropDownDisabled1           { get; set; } = Color.FromArgb(122, 122, 122); // [D] disabled glyph matches disabled text #7A7A7A
    ...
    public override Color AppButtonBack1                   { get; set; } = Color.FromArgb(82, 82, 82);    // [N] backstage — donor +12 (open item 3)
    public override Color AppButtonBack2                   { get; set; } = Color.FromArgb(82, 82, 82);    // [N] backstage — open item 3
    public override Color AppButtonBorder                  { get; set; } = Color.FromArgb(62, 62, 62);    // [N] backstage — open item 3
    public override Color AppButtonOuter1                  { get; set; } = Color.FromArgb(82, 82, 82);    // [N] backstage — open item 3
    public override Color AppButtonOuter2                  { get; set; } = Color.FromArgb(82, 82, 82);    // [N] backstage — open item 3
    public override Color AppButtonOuter3                  { get; set; } = Color.FromArgb(82, 82, 82);    // [N] backstage — open item 3
    public override Color AppButtonInner1                  { get; set; } = GlobalStaticValues.EMPTY_COLOR; // [N]
    public override Color AppButtonInner2                  { get; set; } = Color.FromArgb(62, 62, 62);    // [N]
    ...
    public override Color RibbonGalleryBorder              { get; set; } = Color.FromArgb(101, 101, 101); // [D] separators #656565
    public override Color RibbonGalleryBackNormal          { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    public override Color RibbonGalleryBackTracking        { get; set; } = Color.FromArgb(86, 86, 86);    // [D] well +12 hover step
    public override Color RibbonGalleryBack1               { get; set; } = Color.FromArgb(74, 74, 74);    // [D] control well #4A4A4A
    public override Color RibbonGalleryBack2               { get; set; } = Color.FromArgb(66, 66, 66);    // [D] ribbon #424242
    public override Color RibbonTabTracking3               { get; set; } = Color.FromArgb(58, 58, 58);    // [D] chrome +12 step #3A3A3A (open item 1)
    public override Color RibbonTabTracking4               { get; set; } = GlobalStaticValues.EMPTY_COLOR; // [N]
    public override Color RibbonGroupBorder3               { get; set; } = Color.FromArgb(49, 49, 49);    // [D] side-pane tone #313131 (donor uses darker-than-body)
    public override Color RibbonGroupBorder4               { get; set; } = Color.FromArgb(49, 49, 49);    // [D] #313131
    ...
    public override Color TrackBarTickMarks                { get; set; } = Color.FromArgb(29, 29, 29);    // [N]
    public override Color TrackBarTopTrack                 { get; set; } = Color.FromArgb(49, 49, 49);    // [N]
    ...
    public override Color TrackBarBorderPosition           { get; set; } = Color.FromArgb(47, 47, 47);    // [N]
}
