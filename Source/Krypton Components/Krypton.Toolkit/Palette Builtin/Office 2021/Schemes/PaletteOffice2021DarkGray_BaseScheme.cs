...
// =====================================================================================
// PLACEHOLDER VALUES — real colours land in the per-era fidelity pass.
// This scheme is a straight clone of PaletteMicrosoft365White_BaseScheme so the theme is fully
// wired end-to-end; the authentic Office 2021 DarkGray colour values will replace these in the
// Phase 3 fidelity pass (spec §4.3).
// =====================================================================================
...
public sealed class PaletteOffice2021DarkGray_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(255, 255, 255);
    ...
    public override Color RibbonTabTextNormal              { get; set; } = Color.FromArgb(90, 90, 90);
    public override Color RibbonTabTextChecked             { get; set; } = Color.FromArgb(59, 59, 59);
    public override Color RibbonTabSelected1               { get; set; } = Color.FromArgb(182, 186, 191);
    public override Color RibbonTabSelected2               { get; set; } = Color.FromArgb(248, 247, 247);
    ...
    public override Color RibbonGroupsArea3                { get; set; } = Color.FromArgb(223, 223, 223);
    ...
    public override Color RibbonGroupDialogDark            { get; set; } = Color.FromArgb(102, 109, 124);
    public override Color RibbonGroupDialogLight           { get; set; } = Color.FromArgb(240, 240, 240);
    ...
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(176, 182, 188);
    ...
    public override Color RibbonQATButtonDark              { get; set; } = Color.FromArgb(176, 182, 188);
    public override Color RibbonQATButtonLight             { get; set; } = Color.FromArgb(223, 223, 223);
    ...
    public override Color RibbonGroupSeparatorDark         { get; set; } = Color.FromArgb(176, 182, 188);
    ...
    public override Color RibbonGroupBorder4               { get; set; } = Color.FromArgb(176, 182, 188);
    ...
    public override Color RibbonDropArrowDark              { get; set; } = Color.FromArgb(99, 59, 59);
