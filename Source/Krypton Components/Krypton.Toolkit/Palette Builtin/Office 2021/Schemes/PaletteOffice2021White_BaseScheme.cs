...
// =====================================================================================
// Office 2021/2024 White colour scheme (Bastion Phase 3 fidelity pass, spec §4.3).
//
// Provenance — every value is tagged:
//   [T] taken from docs\themes\office2021-colours.md ("White variant" + "Colorful
//       variant" tables; sources [J]/[K], reference images under
//       docs\themes\references\office2021\).
//       Key values: title bar / tab row #F0F0F0 (240,240,240) — [K] powerpoint-white
//       rects 250,10 / 300,70 (the Win10-era crop; [J] Win11 reads the title band
//       #FAFAFA — recorded as open item 5, decide at fidelity sign-off); toolbar
//       strip #FAFAFA (250,250,250) — [K] powerpoint-white rect 260,102 uniform;
//       ribbon card #FFFFFF; status bar #F5F5F5; everything else "as Colorful minus
//       accent title": tab text #262626, group label #666666 band, group separator
//       #E1E1E1 band, app frame #F0F0F0, Excel headers #F0F0F0, selection #CDE6F7.
//   [D] derived — rule stated inline. Hover/pressed fills, backstage, context menus
//       and inactive-window colours are open items 3/4 in the colour table and
//       await Chris's live-install screenshots. The accent (selected tab text /
//       primary action) is the refreshed Word blue #185ABD; card edge #D1D1D1 from
//       cross-era anchor [M].
//   [N] donor value from PaletteOffice2019White_BaseScheme — era-neutral slot with
//       no 2021-specific evidence.
// =====================================================================================

namespace Krypton.Toolkit;

/// <summary>
/// Provides the colour scheme values that back the Office 2021 White theme (Bastion Phase 3 fidelity pass).
/// </summary>
public sealed class PaletteOffice2021White_BaseScheme : KryptonColorSchemeBase
{
    public override Color TextLabelControl                 { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window text #262626
    ...
    public override Color PanelClient                      { get; set; } = Color.White;                   // [T] ribbon card #FFFFFF — this pipeline fills the ribbon body with PanelClient (2019-pass note)
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(240, 240, 240); // [T] app frame / document surround #F0F0F0 (as Colorful minus accent title)
    public override Color ControlBorder                    { get; set; } = Color.FromArgb(209, 209, 209); // [D] card edge #D1D1D1 from cross-era anchor [M]
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(240, 240, 240); // [T] chrome neutral #F0F0F0
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(240, 240, 240); // [T] chrome neutral #F0F0F0
    public override Color HeaderSecondaryBack1             { get; set; } = Color.FromArgb(250, 250, 250); // [T] strip/pane #FAFAFA
    public override Color HeaderSecondaryBack2             { get; set; } = Color.FromArgb(250, 250, 250); // [T] strip/pane #FAFAFA
    ...
    public override Color ToolStripBack                    { get; set; } = Color.FromArgb(250, 250, 250); // [T] toolbar strip #FAFAFA
    ...
    public override Color ToolStripBegin                   { get; set; } = Color.FromArgb(250, 250, 250); // [T] toolbar strip #FAFAFA
    public override Color ToolStripMiddle                  { get; set; } = Color.FromArgb(250, 250, 250); // [T] toolbar strip #FAFAFA
    public override Color ToolStripEnd                     { get; set; } = Color.FromArgb(250, 250, 250); // [T] toolbar strip #FAFAFA
    ...
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(209, 209, 209); // [D] neutral Win11 outline #D1D1D1 (frame not captured — open item 3)
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive frame — open item 3
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(240, 240, 240); // [T] chrome neutral #F0F0F0 (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(240, 240, 240); // [T] chrome neutral #F0F0F0 (flat frame)
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.FromArgb(240, 240, 240); // [T] title bar #F0F0F0 — no divider
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive — open item 3
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(240, 240, 240); // [T] title bar #F0F0F0 ([K] white rect 250,10; #FAFAFA on Win11 — open item 5)
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(240, 240, 240); // [T] title bar #F0F0F0
    ...
    public override Color FormHeaderShortActive            { get; set; } = Color.FromArgb(38, 38, 38);    // [T] dark title text on light band #262626
    public override Color FormHeaderShortInactive          { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 3
    public override Color FormHeaderLongActive             { get; set; } = Color.FromArgb(38, 38, 38);    // [T] dark title text #262626
    public override Color FormHeaderLongInactive           { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 3
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(166, 172, 179); // [N] caption hover — open item 3
    public override Color FormButtonBack1Track             { get; set; } = Color.FromArgb(225, 225, 225); // [D] caption hover = separator band tone #E1E1E1 (open item 3)
    public override Color FormButtonBack2Track             { get; set; } = Color.FromArgb(225, 225, 225); // [D] #E1E1E1
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(166, 172, 179); // [N]
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(209, 209, 209); // [D] pressed one step darker — #D1D1D1 (open item 3)
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(209, 209, 209); // [D] #D1D1D1
    public override Color TextButtonFormNormal             { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window text #262626
    public override Color TextButtonFormTracking           { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window text #262626
    public override Color TextButtonFormPressed            { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window text #262626
    ...
    public override Color RibbonTabTextNormal              { get; set; } = Color.FromArgb(38, 38, 38);    // [T] tab text #262626 ([K] white rect 300,70 populations)
    public override Color RibbonTabTextChecked             { get; set; } = Color.FromArgb(24, 90, 189);   // [D] selected tab text = era accent #185ABD (underline recorded as accent)
    ...
    public override Color RibbonTabHighlight1              { get; set; } = Color.White;                   // [D] mirrors RibbonTabSelected1
    ...
    public override Color RibbonGroupsArea4                { get; set; } = Color.White;                   // [T] ribbon card #FFFFFF
    ...
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(225, 225, 225); // [D] QAT minibar edge — separator #E1E1E1
    public override Color RibbonQATMini2                   { get; set; } = Color.FromArgb(240, 240, 240); // [T] chrome neutral #F0F0F0
    public override Color RibbonQATMini3                   { get; set; } = Color.FromArgb(240, 240, 240); // [T] chrome neutral #F0F0F0
    ...
    public override Color RibbonQATFullbar1                { get; set; } = Color.FromArgb(250, 250, 250); // [T] toolbar strip #FAFAFA
    public override Color RibbonQATFullbar2                { get; set; } = Color.FromArgb(250, 250, 250); // [T] toolbar strip #FAFAFA
    ...
    public override Color GridSheetColNormal1              { get; set; } = Color.FromArgb(240, 240, 240); // [T] Excel column headers #F0F0F0 (as Colorful)
    ...
    public override Color GridSheetColSelected1            { get; set; } = Color.FromArgb(205, 230, 247); // [T] selection tint #CDE6F7
    ...
    public override Color RibbonGroupTitleText             { get; set; } = Color.FromArgb(102, 102, 102); // [T] group label text #666666 band
