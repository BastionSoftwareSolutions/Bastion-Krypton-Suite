...
/// <summary>A <see cref="KryptonCommand"/> created specifically for the <see cref="PaletteButtonSpecStyle.Cut"/> button spec.</summary>
[Category(@"code")]
[ToolboxItem(false)]
...
public class KryptonIntegratedToolbarCutCommand : KryptonCommand
{
    ...
    private ButtonSpecAny? _cutButtonSpec;
    ...
    private void UpdateActiveImage(Image activeImage)
    {
        ...
        if (_cutButtonSpec != null)
        {
            _cutButtonSpec.ImageStates.ImageTracking = _activeImage;
        }
    }
    ...
    private void UpdateActiveImage(PaletteMode mode)
    {
        ...
        switch (PaletteImageSetResolver.GetImageSetFamily(mode))
        {
            case PaletteImageSetFamily.Inherit:
                break;
            case PaletteImageSetFamily.Professional:
                UpdateActiveImage(SystemToolbarImageResources.SystemToolbarCutNormal);
                break;
            case PaletteImageSetFamily.Office2003:
    ...
    private void UpdateDisabledImage(PaletteMode mode)
    {
        ...
        switch (PaletteImageSetResolver.GetImageSetFamily(mode))
        {
            case PaletteImageSetFamily.Inherit:
                break;
            case PaletteImageSetFamily.Professional:
                UpdateActiveImage(SystemToolbarImageResources.SystemToolbarCutDisabled);
                break;
            case PaletteImageSetFamily.Office2003:
        ...
        if (_cutButtonSpec != null)
        {
            ...
            switch (PaletteImageSetResolver.GetImageSetFamily(mode))
            {
                case PaletteImageSetFamily.Inherit:
                    break;
                case PaletteImageSetFamily.Professional:
                    AddImageStates(null, SystemToolbarImageResources.SystemToolbarCutDisabled, SystemToolbarImageResources.SystemToolbarCutNormal, null);
                    break;
                case PaletteImageSetFamily.Office2003:
