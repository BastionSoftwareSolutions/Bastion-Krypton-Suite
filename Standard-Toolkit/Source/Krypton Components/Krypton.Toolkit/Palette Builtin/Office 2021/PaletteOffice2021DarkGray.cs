...
/// <summary>
/// Provides the Office 2021 DarkGray appearance (Bastion).
/// </summary>
public class PaletteOffice2021DarkGray : PaletteMicrosoft365Base
{
    ...
    static PaletteOffice2021DarkGray()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2021DarkGray class.
    /// </summary>
    public PaletteOffice2021DarkGray() : base(
        new PaletteOffice2021DarkGray_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
