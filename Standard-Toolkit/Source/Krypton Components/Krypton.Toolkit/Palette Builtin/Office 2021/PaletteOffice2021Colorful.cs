...
// =====================================================================================
// Office 2021/2024 Colorful theme (Bastion Phase 3 fidelity pass, spec §4.3).
// Colours come from PaletteOffice2021Colorful_BaseScheme (provenance documented there:
// docs\themes\office2021-colours.md + reference images under
// docs\themes\references\office2021\). This class supplies the chrome the scheme
// slots cannot reach: the NEUTRAL #F0F0F0 tab row of the 2021 Fluent refresh (the
// accent #185ABD stays on the title bar only, unlike 2016/2019) via
// GetRibbonTabRowBackgroundSolidColor, the flat File tab (File renders like the
// other tabs in [K]/[J] — no accent block) via GetRibbonFileAppTab*, plus
// light-glyph caption-button images for the accent title bar. Derives from
...
/// <summary>
/// Provides the Office 2021 Colorful appearance (Bastion).
/// </summary>
public class PaletteOffice2021Colorful : PaletteMicrosoft365Base
{
    #region Static Fields

    #region Ribbon Specific Colors

    // [T] office2021-colours.md: tab row is NEUTRAL #F0F0F0 ([K] word-colorful rect 300,70; [J] rect 300,56).
    ...
    // [T] File tab fill = tab row #F0F0F0 (File renders like the other tabs in [K]/[J]).
    ...
    // Light-glyph (Black set) caption buttons for the accent title bar (mirrors PaletteOffice2019Colorful).
    ...
    static PaletteOffice2021Colorful()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2021Colorful class.
    /// </summary>
    public PaletteOffice2021Colorful() : base(
        new PaletteOffice2021Colorful_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
