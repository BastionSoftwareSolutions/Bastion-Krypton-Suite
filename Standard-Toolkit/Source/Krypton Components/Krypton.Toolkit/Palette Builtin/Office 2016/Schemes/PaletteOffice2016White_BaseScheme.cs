...
// =====================================================================================
// Office 2016 White colour scheme (Bastion Phase 3 fidelity pass, spec §4.3).
//
// Provenance — every value is tagged:
//   [T] taken from docs\themes\office2016-colours.md ("White variant" table; sources
//       [E] powerpoint-white.png / [F] white-theme-2016.png, reference images under
//       docs\themes\references\office2019\ and office2016\).
//       Key values: title bar / tab row / ribbon / status all #FFFFFF; tab text
//       #444444 (68,68,68); selected tab text = app accent (suite theme uses the
//       era's Word blue #2B579A from the accent table); group separator
//       #D5D5D5–#DBDBDB; group label text #666666; pane row #FCFCFC / #E1E1E1.
//   [D] derived — rule stated inline. Hover/pressed fills, backstage, context menus
//       and inactive-window colours are open items in the colour table and await
...
/// <summary>
/// Provides the colour scheme values that back the Office 2016 White theme (Bastion Phase 3 fidelity pass).
/// </summary>
public sealed class PaletteOffice2016White_BaseScheme : KryptonColorSchemeBase
{
    public override Color TextLabelControl                 { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color TextButtonNormal                 { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color TextButtonChecked                { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    ...
    public override Color PanelClient                      { get; set; } = Color.White;                   // [T] chrome white throughout
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(252, 252, 252); // [T] pane background #FCFCFC ([F])
    public override Color ControlBorder                    { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.White;                   // [T] chrome white
    public override Color HeaderPrimaryBack2               { get; set; } = Color.White;                   // [T] chrome white
    public override Color HeaderSecondaryBack1             { get; set; } = Color.FromArgb(252, 252, 252); // [T] pane #FCFCFC
    public override Color HeaderSecondaryBack2             { get; set; } = Color.FromArgb(252, 252, 252); // [T] pane #FCFCFC
    public override Color HeaderText                       { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color StatusStripText                  { get; set; } = Color.FromArgb(68, 68, 68);    // [D] chrome text tone #444444 (status text not separately captured)
    ...
    public override Color ToolStripBack                    { get; set; } = Color.White;                   // [T] chrome white
    public override Color StatusStripLight                 { get; set; } = Color.White;                   // [T] status bar white
    public override Color StatusStripDark                  { get; set; } = Color.White;                   // [T] status bar white
    public override Color ImageMargin                      { get; set; } = Color.White;                   // [N]
    public override Color ToolStripBegin                   { get; set; } = Color.White;                   // [T] chrome white
    public override Color ToolStripMiddle                  { get; set; } = Color.White;                   // [T] chrome white
    public override Color ToolStripEnd                     { get; set; } = Color.White;                   // [T] chrome white
    public override Color OverflowBegin                    { get; set; } = Color.FromArgb(213, 213, 213); // [D] separator tone #D5D5D5 for overflow chrome
    public override Color OverflowMiddle                   { get; set; } = Color.FromArgb(213, 213, 213); // [D] #D5D5D5
    public override Color OverflowEnd                      { get; set; } = Color.FromArgb(213, 213, 213); // [D] #D5D5D5
    public override Color ToolStripBorder                  { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(43, 87, 154);   // [D] accent frame — era Word blue #2B579A (frame not captured)
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive — open item 4
    public override Color FormBorderActiveLight            { get; set; } = Color.White;                   // [T] chrome white
    public override Color FormBorderActiveDark             { get; set; } = Color.White;                   // [T] chrome white
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.White;                   // [T] title bar white — no divider
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(134, 139, 145); // [N] inactive — open item 4
    public override Color FormBorderHeaderActive1          { get; set; } = Color.White;                   // [T] title bar white
    public override Color FormBorderHeaderActive2          { get; set; } = Color.White;                   // [T] title bar white
    ...
    public override Color FormHeaderShortActive            { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color FormHeaderShortInactive          { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 4
    public override Color FormHeaderLongActive             { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color FormHeaderLongInactive           { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 4
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(166, 172, 179); // [N] caption hover — open item 2
    public override Color FormButtonBack1Track             { get; set; } = Color.FromArgb(225, 225, 225); // [T] hover row #E1E1E1 ([F])
    public override Color FormButtonBack2Track             { get; set; } = Color.FromArgb(225, 225, 225); // [T] hover row #E1E1E1
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(166, 172, 179); // [N]
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(213, 213, 213); // [D] pressed one step darker — #D5D5D5 family (open item 2)
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(213, 213, 213); // [D] #D5D5D5
    public override Color TextButtonFormNormal             { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color TextButtonFormTracking           { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color TextButtonFormPressed            { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    ...
    public override Color TextLabelPanel                   { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    public override Color RibbonTabTextNormal              { get; set; } = Color.FromArgb(68, 68, 68);    // [T] tab text (unselected) #444444
    public override Color RibbonTabTextChecked             { get; set; } = Color.FromArgb(43, 87, 154);   // [T] selected tab text = app accent (era Word blue #2B579A)
    public override Color RibbonTabSelected1               { get; set; } = Color.FromArgb(213, 213, 213); // [T] selected tab edge — separator #D5D5D5
    public override Color RibbonTabSelected2               { get; set; } = Color.White;                   // [T] selected tab fill white
    public override Color RibbonTabSelected3               { get; set; } = Color.White;                   // [T] selected tab fill white
    public override Color RibbonTabSelected4               { get; set; } = Color.White;                   // [T] selected tab fill white
    public override Color RibbonTabSelected5               { get; set; } = Color.White;                   // [T] selected tab fill white
    public override Color RibbonTabTracking1               { get; set; } = Color.FromArgb(213, 213, 213); // [D] grey hover #D5D5D5-family per colour-table open item 2
    public override Color RibbonTabTracking2               { get; set; } = Color.FromArgb(232, 232, 232); // [D] lighter grey hover step
    public override Color RibbonTabHighlight1              { get; set; } = Color.FromArgb(213, 213, 213); // [D] mirrors RibbonTabSelected1
    ...
    public override Color RibbonTabSeparatorColor          { get; set; } = Color.FromArgb(213, 213, 213); // [T] separator #D5D5D5
    public override Color RibbonGroupsArea1                { get; set; } = Color.FromArgb(213, 213, 213); // [T] separator #D5D5D5 (ribbon boundary)
    public override Color RibbonGroupsArea2                { get; set; } = Color.FromArgb(213, 213, 213); // [T] separator #D5D5D5
    public override Color RibbonGroupsArea3                { get; set; } = Color.FromArgb(219, 219, 219); // [T] separator range top #DBDBDB
    public override Color RibbonGroupsArea4                { get; set; } = Color.White;                   // [T] ribbon background white
    public override Color RibbonGroupsArea5                { get; set; } = Color.White;                   // [T] ribbon background white
    ...
    public override Color RibbonMinimizeBarDark            { get; set; } = Color.FromArgb(213, 213, 213); // [T] separator #D5D5D5
    public override Color RibbonMinimizeBarLight           { get; set; } = Color.White;                   // [T] ribbon background white
    ...
    public override Color RibbonGroupFrameBorder1          { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    public override Color RibbonGroupFrameBorder2          { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    ...
    public override Color RibbonGroupCollapsedText         { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    ...
    public override Color FormButtonBack1Checked           { get; set; } = Color.FromArgb(157, 166, 174); // [N]
    public override Color FormButtonBack2Checked           { get; set; } = Color.FromArgb(222, 230, 242); // [N]
    public override Color FormButtonBorderCheck            { get; set; } = Color.FromArgb(149, 154, 160); // [N]
    public override Color FormButtonBack1CheckTrack        { get; set; } = Color.FromArgb(147, 156, 164); // [N]
    public override Color FormButtonBack2CheckTrack        { get; set; } = Color.FromArgb(237, 245, 250); // [N]
    public override Color RibbonQATMini1                   { get; set; } = Color.FromArgb(213, 213, 213); // [D] QAT minibar edge — separator #D5D5D5
    public override Color RibbonQATMini2                   { get; set; } = Color.White;                   // [T] chrome white
    public override Color RibbonQATMini3                   { get; set; } = Color.White;                   // [T] chrome white
    ...
    public override Color RibbonQATFullbar1                { get; set; } = Color.White;                   // [T] chrome white
    public override Color RibbonQATFullbar2                { get; set; } = Color.White;                   // [T] chrome white
    public override Color RibbonQATFullbar3                { get; set; } = Color.FromArgb(213, 213, 213); // [T] separator #D5D5D5
    ...
    public override Color RibbonGroupSeparatorDark         { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    ...
    public override Color GridSheetColNormal1              { get; set; } = Color.FromArgb(238, 241, 247); // [N]
    public override Color GridSheetColNormal2              { get; set; } = Color.FromArgb(218, 222, 227); // [N]
    ...
    public override Color GridSheetRowNormal               { get; set; } = Color.FromArgb(223, 227, 232); // [N]
    ...
    public override Color GridDataCellBorder               { get; set; } = Color.FromArgb(218, 220, 221); // [N]
    public override Color GridDataCellSelected             { get; set; } = Color.FromArgb(183, 219, 255); // [N]
    public override Color InputControlTextNormal           { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    ...
    public override Color ContextMenuHeadingText           { get; set; } = Color.FromArgb(68, 68, 68);    // [T] chrome text #444444
    ...
    public override Color RibbonGalleryBorder              { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    ...
    public override Color RibbonTabTracking3               { get; set; } = Color.FromArgb(232, 232, 232); // [D] lighter grey hover step (open item 2)
    public override Color RibbonTabTracking4               { get; set; } = Color.FromArgb(232, 232, 232); // [D] lighter grey hover step
    public override Color RibbonGroupBorder3               { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    public override Color RibbonGroupBorder4               { get; set; } = Color.FromArgb(213, 213, 213); // [T] group separator #D5D5D5
    public override Color RibbonGroupBorder5               { get; set; } = GlobalStaticValues.EMPTY_COLOR; // [N]
    public override Color RibbonGroupTitleText             { get; set; } = Color.FromArgb(102, 102, 102); // [T] ribbon group label text #666666
    ...
    public override Color TrackBarTickMarks                { get; set; } = Color.FromArgb(68, 68, 68);    // [D] chrome text tone #444444 (donor Color.Red was a stray)
