...
// =====================================================================================
// Office 2016 Colorful colour scheme (Bastion Phase 3 fidelity pass, spec §4.3).
//
// Provenance — every value is tagged:
//   [T] taken from docs\themes\office2016-colours.md ("App accent colours" +
//       "Colorful variant" tables; sources [C]/[D]/[G]/[H], reference images under
//       docs\themes\references\office2016\ and office2019\).
//       Key values: accent = Word blue #2B579A (43,87,154); accent hover/darker
//       companion #2C4B7A (44,75,122) from [G]; ribbon/status #F1F1F1 (241,241,241);
//       window text #262626 (38,38,38); group label #666666; separators #D0D0D0;
//       ribbon border #C6C6C6; document surround #E6E6E6; status text #515050.
...
public sealed class PaletteOffice2016Colorful_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color TextButtonNormal                 { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window/ribbon control text #262626
    public override Color TextButtonChecked                { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window/ribbon control text #262626
    ...
    public override Color PanelClient                      { get; set; } = Color.FromArgb(241, 241, 241); // [T] ribbon/chrome neutral #F1F1F1
    public override Color PanelAlternative                 { get; set; } = Color.FromArgb(230, 230, 230); // [T] document surround #E6E6E6
    public override Color ControlBorder                    { get; set; } = Color.FromArgb(198, 198, 198); // [T] ribbon bottom border #C6C6C6
    ...
    public override Color HeaderPrimaryBack1               { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color HeaderPrimaryBack2               { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    ...
    public override Color StatusStripText                  { get; set; } = Color.FromArgb(81, 80, 80);    // [T] status bar text #515050
    ...
    public override Color ToolStripBack                    { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color StatusStripLight                 { get; set; } = Color.FromArgb(241, 241, 241); // [T] status bar #F1F1F1 (open item 1: RTM may fill with accent)
    public override Color StatusStripDark                  { get; set; } = Color.FromArgb(241, 241, 241); // [T] status bar #F1F1F1 (open item 1)
    public override Color ImageMargin                      { get; set; } = Color.White;                   // [N]
    public override Color ToolStripBegin                   { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color ToolStripMiddle                  { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color ToolStripEnd                     { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color OverflowBegin                    { get; set; } = Color.FromArgb(198, 198, 198); // [D] ribbon border tone #C6C6C6 for overflow chrome
    public override Color OverflowMiddle                   { get; set; } = Color.FromArgb(198, 198, 198); // [D] ribbon border tone #C6C6C6
    public override Color OverflowEnd                      { get; set; } = Color.FromArgb(198, 198, 198); // [D] ribbon border tone #C6C6C6
    public override Color ToolStripBorder                  { get; set; } = Color.FromArgb(198, 198, 198); // [T] ribbon bottom border #C6C6C6
    ...
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(43, 87, 154);   // [T] title bar active = accent #2B579A
    ...
    public override Color FormHeaderShortActive            { get; set; } = Color.White;                   // [T] title bar text white on accent
    public override Color FormHeaderShortInactive          { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 4
    public override Color FormHeaderLongActive             { get; set; } = Color.White;                   // [T] title bar text white on accent
    public override Color FormHeaderLongInactive           { get; set; } = Color.FromArgb(138, 138, 138); // [N] inactive — open item 4
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(44, 75, 122);   // [D] caption hover = [G] darker companion #2C4B7A (hover open item 2)
    ...
    public override Color RibbonTabSelected1               { get; set; } = Color.FromArgb(241, 241, 241); // [T] selected tab fill #F1F1F1 — flat, borderless
    public override Color RibbonTabSelected2               { get; set; } = Color.FromArgb(241, 241, 241); // [T] selected tab fill #F1F1F1
    public override Color RibbonTabSelected3               { get; set; } = Color.FromArgb(241, 241, 241); // [T] selected tab fill #F1F1F1
    public override Color RibbonTabSelected4               { get; set; } = Color.FromArgb(241, 241, 241); // [T] selected tab fill #F1F1F1
    public override Color RibbonTabSelected5               { get; set; } = Color.FromArgb(241, 241, 241); // [T] selected tab fill #F1F1F1
    public override Color RibbonTabTracking1               { get; set; } = Color.FromArgb(44, 75, 122);   // [D] tab hover on accent row = [G] darker companion #2C4B7A (open item 2)
    public override Color RibbonTabTracking2               { get; set; } = Color.FromArgb(44, 75, 122);   // [D] #2C4B7A ([G] darker companion)
    public override Color RibbonTabHighlight1              { get; set; } = Color.FromArgb(241, 241, 241); // [D] mirrors RibbonTabSelected1 (flat selected look)
    public override Color RibbonTabHighlight2              { get; set; } = Color.FromArgb(241, 241, 241); // [D] mirrors selected fill
    public override Color RibbonTabHighlight3              { get; set; } = Color.FromArgb(241, 241, 241); // [D] mirrors selected fill
    public override Color RibbonTabHighlight4              { get; set; } = Color.FromArgb(241, 241, 241); // [D] mirrors selected fill
    public override Color RibbonTabHighlight5              { get; set; } = Color.FromArgb(241, 241, 241); // [D] mirrors selected fill
    public override Color RibbonTabSeparatorColor          { get; set; } = Color.FromArgb(43, 87, 154);   // [D] accent — 2016 draws no tab separators on the accent row
    public override Color RibbonGroupsArea1                { get; set; } = Color.FromArgb(198, 198, 198); // [T] ribbon bottom border #C6C6C6
    public override Color RibbonGroupsArea2                { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
    public override Color RibbonGroupsArea3                { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
    public override Color RibbonGroupsArea4                { get; set; } = Color.FromArgb(241, 241, 241); // [T] ribbon background #F1F1F1
    public override Color RibbonGroupsArea5                { get; set; } = Color.FromArgb(241, 241, 241); // [T] ribbon background #F1F1F1
    ...
    public override Color RibbonMinimizeBarDark            { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
    public override Color RibbonMinimizeBarLight           { get; set; } = Color.FromArgb(241, 241, 241); // [T] ribbon background #F1F1F1
    ...
    public override Color RibbonGroupFrameBorder1          { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator line #D0D0D0
    public override Color RibbonGroupFrameBorder2          { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator line #D0D0D0
    ...
    public override Color RibbonGroupCollapsedText         { get; set; } = Color.FromArgb(38, 38, 38);    // [T] window/ribbon control text #262626
    ...
    public override Color RibbonQATFullbar1                { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color RibbonQATFullbar2                { get; set; } = Color.FromArgb(241, 241, 241); // [T] chrome neutral #F1F1F1
    public override Color RibbonQATFullbar3                { get; set; } = Color.FromArgb(198, 198, 198); // [T] ribbon bottom border #C6C6C6
    ...
    public override Color RibbonGroupSeparatorDark         { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
    ...
    public override Color GridSheetColPressed1             { get; set; } = Color.FromArgb(208, 208, 208); // [D] header pressed — separator tone #D0D0D0 (hover open item 2)
    public override Color GridSheetColPressed2             { get; set; } = Color.FromArgb(208, 208, 208); // [D] #D0D0D0
    public override Color GridSheetColSelected1            { get; set; } = Color.FromArgb(205, 230, 247); // [T] selection tint #CDE6F7 (Outlook selected item)
    ...
    public override Color GridSheetRowPressed              { get; set; } = Color.FromArgb(208, 208, 208); // [D] #D0D0D0
    ...
    public override Color RibbonGalleryBorder              { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
    ...
    public override Color RibbonTabTracking3               { get; set; } = Color.FromArgb(44, 75, 122);   // [D] #2C4B7A ([G] darker companion — hover open item 2)
    public override Color RibbonTabTracking4               { get; set; } = Color.FromArgb(44, 75, 122);   // [D] #2C4B7A
    public override Color RibbonGroupBorder3               { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
    public override Color RibbonGroupBorder4               { get; set; } = Color.FromArgb(208, 208, 208); // [T] group separator #D0D0D0
