...
// =====================================================================================
// Office 2016 White theme (Bastion Phase 3 fidelity pass, spec §4.3).
// Colours come from PaletteOffice2016White_BaseScheme (provenance documented there:
// docs\themes\office2016-colours.md "White variant" + reference images). Chrome is
// white throughout ([E]/[F]); the tab row stays white and only the File app-button
// carries the accent fill (era Word blue #2B579A; [E] shows the per-app accent, [F]
// shows the filled FILE tab). Derives from PaletteMicrosoft365Base and reuses
...
/// <summary>
/// Provides the Office 2016 White appearance (Bastion).
/// </summary>
public class PaletteOffice2016White : PaletteMicrosoft365Base
{
    ...
    // [T] File button fill = app accent (era Word blue #2B579A; [F] shows accent-filled FILE tab).
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2016White class.
    /// </summary>
    public PaletteOffice2016White() : base(
        new PaletteOffice2016White_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
