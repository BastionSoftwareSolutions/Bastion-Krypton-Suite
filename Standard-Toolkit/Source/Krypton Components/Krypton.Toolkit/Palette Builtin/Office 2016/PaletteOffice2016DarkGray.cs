...
// =====================================================================================
// Office 2016 Dark Gray theme (Bastion Phase 3 fidelity pass, spec §4.3).
// Colours come from PaletteOffice2016DarkGray_BaseScheme (provenance documented there:
// docs\themes\office2016-colours.md "Dark Gray variant" + reference images). This
// class supplies the chrome the scheme slots cannot reach: the #444444 tab row
// (GetRibbonTabRowBackgroundSolidColor) and the #333333 File app-button ([F] FILE tab
// fill), plus light-glyph caption-button images for the dark title bar. Derives from
...
/// <summary>
/// Provides the Office 2016 DarkGray appearance (Bastion).
/// </summary>
public class PaletteOffice2016DarkGray : PaletteMicrosoft365Base
{
    #region Static Fields

    #region Ribbon Specific Colors

    // [T] office2016-colours.md: tab row #444444 ([E] rects 250,8 / 300,42).
    private static readonly Color _tabRowBackgroundColor = Color.FromArgb(68, 68, 68);

    // [D] File button hover/pressed fill — FILE fill +26/channel (hover open item 2).
    private static readonly Color _ribbonAppButtonDarkColor = Color.FromArgb(77, 77, 77);

    // [T] File button fill = FILE tab fill #333333 ([F] rect 20,38).
    ...
    static PaletteOffice2016DarkGray()
    {
    ...
    /// <summary>
    /// Initialize a new instance of the PaletteOffice2016DarkGray class.
    /// </summary>
    public PaletteOffice2016DarkGray() : base(
        new PaletteOffice2016DarkGray_BaseScheme(),
        _checkBoxList,
        _galleryButtonList,
        _radioButtonArray)
    {
