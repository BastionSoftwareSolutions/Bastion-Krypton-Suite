...
// =====================================================================================
// Microsoft 365 "White" colour scheme — 2026 refresh (Bastion Phase 3, spec §4.2 item 4).
//
// VARIANT MAPPING (Bastion decision): Microsoft365White is refreshed as the real M365
// "WHITE" variant — the neutral #E9EEF2 frame shared with Colorful, but with the accent
// title fill dropped (dark #3A3A38 caption text on the neutral frame). Canonical app =
// Word, so accent-carrying slots use #185ABD/#1651AA; the [M4] underline sample #B13719
// is PowerPoint's app accent, not a "White theme colour". Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365White.png.
//
// Provenance — every value is tagged:
//   [T] taken from docs\themes\m365-2026-colours.md ("White variant" table, source [M4]
//       powerpoint-white-theme.png; shared neutrals corroborated by [M1]/[M2]/[M3]).
//       Key values: title bar / app frame / tab row #E9EEF2 (233,238,242); title bar
//       text #3A3A38 (58,58,56); ribbon card #FFFFFF with #FAFAFA gradient edge;
//       tab text #242424; group label #555758; separator/card edge #D1D1D1 with
//       #DDE2E6 shadow step; control borders #8A8A8A; status #F5F5F5/#616161;
//       ruler-margin neutral #DCE0E4; gutter #DBDBDB–#E4E4E4.
//   [D] derived — rule stated inline. Caption-button hover = shadow step #DDE2E6,
//       pressed = ruler neutral #DCE0E4 (hover/pressed are colour-table open item 2).
//       Accent slots use the canonical Word accent system (#185ABD/#1651AA/#12448E).
