...
// =====================================================================================
// Microsoft 365 "Black Dark Mode" colour scheme — 2026 refresh (Bastion Phase 3,
// spec §4.2 item 4).
//
// VARIANT MAPPING (Bastion decision): Microsoft365Black and Microsoft365BlackDarkMode
// BOTH map to the real M365 "BLACK" variant (Black doubles as the system Dark Mode in
// 2026). The chrome values here are identical to PaletteMicrosoft365Black_BaseScheme
// ([T] #1C2227 frame, #292929 card, #DEDFE0/#FFFFFF text, #60BD82 accent). The one
// deliberate difference: this palette runs on the PaletteMicrosoft365BlackDarkModeBase
// clone base, which renders LIGHT text on grids/lists/menus — so the [M6] Excel-black
// grid evidence (#0A0A0A header band, #5B9DDA/#649BCF selection accents) and dark
// list/menu canvases live HERE, while the shared-base Black keeps a light grid canvas.
// Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365BlackDarkMode.png.
//
// Provenance tags: [T] = docs\themes\m365-2026-colours.md table value ([M6]);
// [D] = derived (rule inline; card steps +12 well #353535, +20 separator #3D3D3D);
// [N] = 2021-pass donor with no 2026-specific evidence.
// =====================================================================================
