...
// =====================================================================================
// Microsoft 365 "Blue Dark Mode" colour scheme — 2026 refresh (Bastion Phase 3,
// spec §4.2 item 4).
//
// VARIANT MAPPING (Bastion decision): no real-2026 counterpart; kept as a Krypton
// convenience DERIVED as "Colorful over the Black ladder": the real Black body
// ([T] #1C2227 frame, #292929 card, [M6]) under the parent Blue/Colorful accent
// chrome — #185ABD title bar, #1651AA hover, #12448E pressed. The selected-tab accent
// is the authentic Word-on-dark tint #AEC6F0 ([M5] col scan x=194 — the Word-blue
// underline on dark chrome). Pre-refresh look preserved in
// docs\themes\comparisons\placeholder\Microsoft365BlueDarkMode.png.
//
// Provenance tags: [T] = docs\themes\m365-2026-colours.md table value ([M5]/[M6]);
// [D] = derived (rule inline or the accent-over-dark rule above); [N] = 2021-pass
// donor with no 2026-specific evidence.
// =====================================================================================
...
public sealed class PaletteMicrosoft365BlueDarkMode_BaseScheme : KryptonColorSchemeBase
{
    ...
    public override Color FormBorderActive                 { get; set; } = Color.FromArgb(24, 90, 189);   // [D] Colorful-over-dark: accent #185ABD active frame
    public override Color FormBorderInactive               { get; set; } = Color.FromArgb(119, 119, 119); // [N] inactive frame — colour-table open item 4
    public override Color FormBorderActiveLight            { get; set; } = Color.FromArgb(24, 90, 189);   // [D] accent #185ABD (flat frame)
    public override Color FormBorderActiveDark             { get; set; } = Color.FromArgb(24, 90, 189);   // [D] accent #185ABD (flat frame)
    ...
    public override Color FormBorderHeaderActive           { get; set; } = Color.FromArgb(24, 90, 189);   // [D] accent #185ABD — caption merges into chrome
    public override Color FormBorderHeaderInactive         { get; set; } = Color.FromArgb(154, 154, 154); // [N] inactive — open item 4
    public override Color FormBorderHeaderActive1          { get; set; } = Color.FromArgb(24, 90, 189);   // [D] accent #185ABD title bar (Blue identity over the Black body)
    public override Color FormBorderHeaderActive2          { get; set; } = Color.FromArgb(24, 90, 189);   // [D] accent #185ABD
    ...
    public override Color FormButtonBorderTrack            { get; set; } = Color.FromArgb(22, 81, 170);   // [D] caption hover = accent companion #1651AA
    ...
    public override Color FormButtonBorderPressed          { get; set; } = Color.FromArgb(18, 68, 142);   // [D] pressed = accent 25% toward black
    public override Color FormButtonBack1Pressed           { get; set; } = Color.FromArgb(18, 68, 142);   // [D] #12448E
    public override Color FormButtonBack2Pressed           { get; set; } = Color.FromArgb(18, 68, 142);   // [D] #12448E
    ...
    public override Color RibbonTabTextChecked             { get; set; } = Color.FromArgb(174, 198, 240); // [T] Word dark accent #AEC6F0 ([M5] col scan x=194 — Word-blue underline on dark chrome)
    ...
    public override Color FormButtonBack1Checked           { get; set; } = Color.FromArgb(22, 81, 170);   // [D] checked caption button = #1651AA
    ...
    public override Color FormButtonBack1CheckTrack        { get; set; } = Color.FromArgb(18, 68, 142);   // [D] #12448E
    public override Color FormButtonBack2CheckTrack        { get; set; } = Color.FromArgb(18, 68, 142);   // [D] #12448E
    ...
    public override Color TrackBarBorderPosition           { get; set; } = Color.FromArgb(174, 198, 240); // [D] Word dark accent #AEC6F0
}
