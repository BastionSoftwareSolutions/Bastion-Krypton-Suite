...
'
' VB.NET twin of Source\Krypton Toolkit Examples\Expanding HeaderGroups (Stack)\Form1.cs (Bastion Phase 4c).
#End Region
...
Public Class Form1
    ...
    Private Sub kryptonHeaderTop_CollapsedChanged(sender As Object, e As EventArgs) Handles kryptonHeaderTop.CollapsedChanged
        kryptonBorderEdgeTop.Visible = Not kryptonHeaderTop.Collapsed
    End Sub

    Private Sub kryptonHeaderBottom_CollapsedChanged(sender As Object, e As EventArgs) Handles kryptonHeaderBottom.CollapsedChanged
        kryptonBorderEdgeBottom.Visible = Not kryptonHeaderBottom.Collapsed
    End Sub
