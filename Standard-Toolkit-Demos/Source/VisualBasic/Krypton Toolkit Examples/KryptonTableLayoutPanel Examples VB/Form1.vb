...
'
' VB.NET twin of Source\Krypton Toolkit Examples\KryptonTableLayoutPanel Examples\Form1.cs (Bastion Phase 4c).
#End Region
...
Public Class Form1
    ...
    Private Sub kryptonPanel_MouseDown(sender As Object, e As MouseEventArgs) Handles _
        panel1Office.MouseDown, panel2Office.MouseDown, panel3Office.MouseDown, panel4Office.MouseDown,
        panel1Blue.MouseDown, panel2Blue.MouseDown, panel3Blue.MouseDown, panel4Blue.MouseDown,
        panel1Custom.MouseDown, panel2Custom.MouseDown, panel3Custom.MouseDown, panel4Custom.MouseDown

        ' Setup the property grid to edit this panel
        propertyGrid.SelectedObject = New KryptonPanelProxy(DirectCast(sender, KryptonTableLayoutPanel))
    End Sub
...
Public Class KryptonPanelProxy
    ...
    Private _panel As KryptonTableLayoutPanel

    Public Sub New(panel As KryptonTableLayoutPanel)
        _panel = panel
    End Sub
