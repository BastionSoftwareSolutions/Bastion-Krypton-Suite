...
Runs after the A1–A8 fixes (test counts differ per TFM because the Extended fixtures are
...
Endurance durations, net48: RapidCycle 2,500 — Toolkit 6m54s, Ribbon 7m44s, Navigator
